        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!(administrador.isChecked() ||  empleado.isChecked()) ){
                    Toast.makeText(RegistroUsuario.this, "Selecione un tipo de cuenta", Toast.LENGTH_SHORT).show();
                    return;
                ...
                if(valid){
                    ...
                    fAuth.createUserWithEmailAndPassword(String.valueOf(email.getText()),password.getText().toString()).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                        ...
                        public void onSuccess(AuthResult authResult) {
                            ...
                            Toast.makeText(RegistroUsuario.this, "Cuenta creada", Toast.LENGTH_SHORT).show();
                            ...
                            if(empleado.isChecked()){
                                startActivity(new Intent(getApplicationContext(),Empleado.class));
                                finish();
                            }
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(RegistroUsuario.this, "No se acreado la cuenta", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
